...
export const DEVICE_TYPE_MAP: Record<string, DeviceTypeDefinition> = {
  ...
  '0x0001': { hexCode: '0x0001', description: 'Water Heater - Gas', category: 'SGD' },
  '0x0002': { hexCode: '0x0002', description: 'Water Heater - Electric', category: 'SGD' },
  '0x0003': { hexCode: '0x0003', description: 'Water Heater - Heat Pump', category: 'SGD' },
  '0x0004': { hexCode: '0x0004', description: 'Central AC – Heat Pump', category: 'SGD' },
  '0x0005': { hexCode: '0x0005', description: 'Central AC – Fossil Fuel Heat', category: 'SGD' },
  '0x0006': { hexCode: '0x0006', description: 'Central AC – Resistance Heat', category: 'SGD' },
  '0x0007': { hexCode: '0x0007', description: 'Central AC (only)', category: 'SGD' },
  '0x0008': { hexCode: '0x0008', description: 'Evaporative Cooler', category: 'SGD' },
  '0x0009': { hexCode: '0x0009', description: 'Baseboard Electric Heat', category: 'SGD' },
  '0x000A': { hexCode: '0x000A', description: 'Window AC', category: 'SGD' },
  '0x000B': { hexCode: '0x000B', description: 'Portable Electric Heater', category: 'SGD' },
  '0x000C': { hexCode: '0x000C', description: 'Clothes Washer', category: 'SGD' },
  '0x000D': { hexCode: '0x000D', description: 'Clothes Dryer - Gas', category: 'SGD' },
  '0x000E': { hexCode: '0x000E', description: 'Clothes Dryer - Electric', category: 'SGD' },
  '0x000F': { hexCode: '0x000F', description: 'Refrigerator/Freezer', category: 'SGD' },
  '0x0010': { hexCode: '0x0010', description: 'Freezer', category: 'SGD' },
  '0x0011': { hexCode: '0x0011', description: 'Dishwasher', category: 'SGD' },
  '0x0012': { hexCode: '0x0012', description: 'Microwave Oven', category: 'SGD' },
  '0x0013': { hexCode: '0x0013', description: 'Oven – Electric', category: 'SGD' },
  '0x0014': { hexCode: '0x0014', description: 'Oven – Gas', category: 'SGD' },
  '0x0015': { hexCode: '0x0015', description: 'Cook Top – Electric', category: 'SGD' },
  '0x0016': { hexCode: '0x0016', description: 'Cook Top – Gas', category: 'SGD' },
  '0x0017': { hexCode: '0x0017', description: 'Stove – Electric', category: 'SGD' },
  '0x0018': { hexCode: '0x0018', description: 'Stove – Gas', category: 'SGD' },
  '0x0019': { hexCode: '0x0019', description: 'Dehumidifier', category: 'SGD' },
  '0x001A': { hexCode: '0x001A', description: 'Central AC – Heat Pump Variable Capacity', category: 'SGD' },
  '0x001B': { hexCode: '0x001B', description: 'Water Heater – Heat Pump Variable Capacity/Speed', category: 'SGD' },
  '0x001C': { hexCode: '0x001C', description: 'Water Heater - Phase Change Material', category: 'SGD' },
  ...
  '0x4001': { hexCode: '0x4001', description: 'PLC (other, non-standard)', category: 'UCM' },
  '0x4002': { hexCode: '0x4002', description: 'Wired (other, non-standard)', category: 'UCM' },
  '0x4003': { hexCode: '0x4003', description: 'IEEE 802.15.4 (e.g., ZigBee)', category: 'UCM' },
  '0x4004': { hexCode: '0x4004', description: 'IEEE 802.11 (e.g., Wi-Fi)', category: 'UCM' },
  '0x4005': { hexCode: '0x4005', description: 'IEEE 802.16 (e.g., WiMAX)', category: 'UCM' },
  '0x4006': { hexCode: '0x4006', description: 'VHF/UHF Pager', category: 'UCM' },
